...
if False: # Read the weights and plot prior and posteri parameters set
    ...
    if True: ### New 8-parameter simulations (MIROC85_2600_8var - the default range)
        ### Copy from below
...
if True: # Create parameters by the Latin-Hyper-Cube
    ...
    if False: ### New 8-parameter simulations (MIROC85_2600_8var) - **** Default in our study
    ...
    if True: ### New 8-parameter simulations - A range that shifts towards ISMIP6 (for us to create Figure S6-Out emulation with a new range)
        X1_min=0.1; X1_max=45  # Phi-min
        X2_min=0.0000125; X2_max=0.00008 # E-SIA
        X3_min=0.0025; X3_max=0.015 # Ki
        X4_min=0.001; X4_max=0.007 # Ks
        X5_min=270; X5_max=273 # T-melt threshold
        X6_min=1; X6_max=5 # T-std
        X7_min=0.2; X7_max=0.9 # R-refreeze
        X8_min=0.5; X8_max=1 # E-SSA
        save_add='8param_range_ISMIP' 
