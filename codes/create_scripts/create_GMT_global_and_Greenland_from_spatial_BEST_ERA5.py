...
if __name__ == "__main__":
    ...
    if False:
        ...
        models=['CCSM4_26','CCSM4_45','CCSM4_60','CCSM4_85', # CCSM4 data has some problem
                ...
                'GISS-E2-H_26', 'GISS-E2-H_45', 
                'GISS-E2-H_60', 'GISS-E2-H_85']; before2016_miroc26en1=False; time_pad_st=2101; create_CMIP5_model_rcp_mean=True; model_folder='CMIP5'
    ...
    #models=['ERA5']; before2016_miroc26en1=False; time_pad_st=np.nan; model_folder='ERA5' # ERA5 has no 1850. Produce nan
    models=['BEST']; before2016_miroc26en1=False; time_pad_st=np.nan; model_folder='BEST' # We don't do padding (i.e, extend up to 2300) for obs because now it can be directly smoothed by filter
    ###!!!!
    # The lat-lon derived BEST is slightly difference from the direct timeseries we use - probably related to the regridding method
    ###!!!
    ...
    ### Get the filenames for models or observations
    if True: # TAS
        var='tas'
        model_hist_files={
    ...
    for mm, model in enumerate(models):
        ...
        for en in ensembles:
            for region in regions:
                ...
                gmt_tss[model][en][region]=gmt_tss_unsmooth[model][en][region]
        ...
        for model in models:
            for en in ensembles:
                for region in regions:
                    ...
                    np.save('/Users/home/siewpe/codes/greenland_emulator/save_gmt/tas_ts_create/%s/gmt_%s_%s_en%s_%s.npy'%(model_folder,var,model,en,region),save_data)



    ###
    ### Start plotting the timeseies
    models_colors={'ctrlProj':"k",'MIROC_85':'red','MIROC_26':'green','HadGEM2_85':'orange',
            'NorESM_85':'brown','MIROC_2685mean':'blue','MIROC_2685_cooling':'violet',
    ...
    if True: # Start plotting the maps (it doesn't work for ERA5) - As we expect - this create a slightly stronger GMT in the new version
